...
# The shader cache is generated by running the `isaac-sim-simulation-example.py` for the first time on Cloab. (~30 mins)
# After the first run, the required shader cache will be saved in the following directories:
#
#     zip -r /content/nvshadercache.zip /usr/local/lib/python3.10/site-packages/omni/cache/nv_shadercache
...
wget -O nvshadercache.zip https://github.com/j3soon/isaac-sim-colab/releases/download/v0.0.1/nvshadercache_pip-4.5_python-script_T5-gpu.zip
